...
1. Upload the plugin files to the `/wp-content/plugins/metalation-calculator-wp` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress


== Screenshots ==

1. Screenshot showing the calculator rendered on a page.
